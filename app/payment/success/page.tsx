  ...
  return (
    <div className="mx-auto max-w-lg rounded-2xl border border-slate-200 bg-white p-6 shadow-xl sm:rounded-3xl sm:p-8">
      <div className="text-center">
        ...
        <h1 className="mt-4 text-2xl font-bold text-slate-900 sm:text-3xl">Payment Successful!</h1>
        <p className="mt-2 text-sm text-slate-600 sm:text-base">
          Your payment was processed successfully. Your wallet balance has been updated.
        </p>
